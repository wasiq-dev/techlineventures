...
export const portfolio: PortfolioItem[] = [
  ...
  },
  {
    ...
    category: "Mobile",
    tag: "Patient scheduling",
    summary: "A patient-friendly mobile app for appointments, reminders, and doctor discovery with a clean healthcare-focused UX.",
    highlights: ["Scheduling", "Notifications", "Patient UX"],
    impact: "Simplified bookings and reduced front-desk coordination load.",
  },
  {
    id: "p6",
  ...
  },
  {
    ...
    category: "Web",
    tag: "Lead-focused presence",
    summary: "A polished business website built to improve trust, communicate service depth, and generate qualified inbound leads.",
    highlights: ["Brand pages", "Lead capture", "Performance"],
    impact: "Turned a static web presence into a more effective sales asset.",
  },
  {
    id: "p7",
  ...
  },
  {
    ...
    category: "Software",
    tag: "Internal workflow system",
    summary: "A custom HR platform for employee records, approvals, leave management, and role-based visibility across departments.",
    highlights: ["Approvals", "Records", "Role access"],
    impact: "Reduced repetitive admin effort and improved team-wide process visibility.",
  },
  {
    id: "p12",
    title: "Fashion Storefront Experience",
    category: "E-Commerce",
    tag: "Mobile-first catalog",
    summary: "A fashion commerce build focused on merchandising, product storytelling, and a cleaner checkout journey for mobile buyers.",
    highlights: ["Merchandising", "Mobile UX", "Checkout"],
    impact: "Improved product discovery and supported better purchase intent.",
  },
  {
    id: "p13",
    title: "Wholesale Ordering Portal",
    category: "E-Commerce",
    tag: "B2B reorder flow",
    summary: "A B2B commerce portal designed around quick bulk ordering, account-based pricing, and repeat purchase convenience.",
    highlights: ["Bulk orders", "Account pricing", "Reorders"],
    impact: "Made recurring orders faster and easier for wholesale customers.",
  },
];
